...
const Savings = () => {
  ...
  const dataSortedByAmount = [...savingsData]?.sort((a, b) => {
  ...
  const totalSavings = [...dataFilteredByCategory]?.reduce(
  ...
  return (
    <div>
      ...
      {isOpen && (
        <EntryModal isOpen={isOpen} onClose={onClose} entryType={"savings"} />
      )}
